...
(cl:defmethod cl:initialize-instance :after ((m <jet2ard>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'jet2ard)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name main_msg-msg:<jet2ard> is deprecated: use main_msg-msg:jet2ard instead.")))

(cl:ensure-generic-function 'throttle-val :lambda-list '(m))
(cl:defmethod throttle-val ((m <jet2ard>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main_msg-msg:throttle-val is deprecated.  Use main_msg-msg:throttle instead.")
  (throttle m))

(cl:ensure-generic-function 'brake-val :lambda-list '(m))
(cl:defmethod brake-val ((m <jet2ard>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main_msg-msg:brake-val is deprecated.  Use main_msg-msg:brake instead.")
  (brake m))

(cl:ensure-generic-function 'stop_sign-val :lambda-list '(m))
(cl:defmethod stop_sign-val ((m <jet2ard>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main_msg-msg:stop_sign-val is deprecated.  Use main_msg-msg:stop_sign instead.")
  (stop_sign m))

(cl:ensure-generic-function 'start_time-val :lambda-list '(m))
(cl:defmethod start_time-val ((m <jet2ard>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main_msg-msg:start_time-val is deprecated.  Use main_msg-msg:start_time instead.")
  (start_time m))
