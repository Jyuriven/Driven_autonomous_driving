...
(cl:defmethod cl:initialize-instance :after ((m <det_info>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'det_info)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name main_msg-msg:<det_info> is deprecated: use main_msg-msg:det_info instead.")))

(cl:ensure-generic-function 'emg_stop-val :lambda-list '(m))
(cl:defmethod emg_stop-val ((m <det_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main_msg-msg:emg_stop-val is deprecated.  Use main_msg-msg:emg_stop instead.")
  (emg_stop m))

(cl:ensure-generic-function 'stop_rate-val :lambda-list '(m))
(cl:defmethod stop_rate-val ((m <det_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main_msg-msg:stop_rate-val is deprecated.  Use main_msg-msg:stop_rate instead.")
  (stop_rate m))
