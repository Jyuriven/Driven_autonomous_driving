...
(cl:defmethod cl:initialize-instance :after ((m <g_map>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'g_map)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cloud_msgs-msg:<g_map> is deprecated: use cloud_msgs-msg:g_map instead.")))

(cl:ensure-generic-function 'x_lst-val :lambda-list '(m))
(cl:defmethod x_lst-val ((m <g_map>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cloud_msgs-msg:x_lst-val is deprecated.  Use cloud_msgs-msg:x_lst instead.")
  (x_lst m))

(cl:ensure-generic-function 'y_lst-val :lambda-list '(m))
(cl:defmethod y_lst-val ((m <g_map>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cloud_msgs-msg:y_lst-val is deprecated.  Use cloud_msgs-msg:y_lst instead.")
  (y_lst m))

(cl:ensure-generic-function 'car_x-val :lambda-list '(m))
(cl:defmethod car_x-val ((m <g_map>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cloud_msgs-msg:car_x-val is deprecated.  Use cloud_msgs-msg:car_x instead.")
  (car_x m))

(cl:ensure-generic-function 'car_y-val :lambda-list '(m))
(cl:defmethod car_y-val ((m <g_map>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cloud_msgs-msg:car_y-val is deprecated.  Use cloud_msgs-msg:car_y instead.")
  (car_y m))
